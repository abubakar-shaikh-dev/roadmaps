...
**Mini Project Task Challenge**: Build a basic Angular app with a few components and templates.
...
- Making HTTP requests in Angular using the HttpClient module
